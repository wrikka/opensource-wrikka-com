...
1. Add to your `Cargo.toml`
   ...
   ```toml
   [dependencies]
   wrikka-create-cli = { git = "https://github.com/wrikka/opensource-wrikka-com", path = "packages/tools/create-cli" }
   ```
...
create-cli create-app my-app 1.0.0 "My first CLI application"

# List applications
create-cli list-apps --limit 20

# Add a command
create-cli add-command <APP_ID> hello "Say hello" handle_hello

# Generate code
create-cli generate <APP_ID> rust lib

# Generate shell completions
create-cli completion <APP_ID> bash

# Generate man page
create-cli man-page <APP_ID> 1

# Import from config file
create-cli import-config ./my-app.yaml

# Generate interactive prompts
create-cli generate-prompts <APP_ID> select

# Generate progress indicators
create-cli generate-progress <APP_ID> bar

# Show application details
create-cli show my-app
```
