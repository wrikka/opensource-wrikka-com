...
- 📄 `opensource-wrikka-com/uno.config.ts`
...
- `packages/sdk/terminal-sdk`
- `# Agent SDK packages
    "packages/sdk/agents-sdk/core`
- `packages/sdk/agents-sdk/security`
- `packages/sdk/agents-sdk/integrations`
- `packages/sdk/agents-sdk/channels`
- `packages/sdk/agents-sdk/tools`
